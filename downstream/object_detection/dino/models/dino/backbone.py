...
def build_backbone(args):
    ...
    if args.backbone in ['resnet50', 'resnet101']:
    ...
    elif args.backbone in ['faster_vit_0_224',
                           'faster_vit_1_224',
                           'faster_vit_2_224',
                           'faster_vit_3_224',
                           'faster_vit_4_224', 
        ...
        backbone = build_fastervit(args.backbone,
                               out_indices=tuple(return_interm_indices),
        ...
        pretrained_dir = args.backbone_dir
        PTDICT = {
            'faster_vit_0_224': 'fastervit_0_224_1k.pth.tar',
            'faster_vit_1_224': 'fastervit_1_224_1k.pth.tar',
            'faster_vit_2_224': 'fastervit_2_224_1k.pth.tar',
            'faster_vit_3_224': 'fastervit_3_224_1k.pth.tar',
            'faster_vit_4_224': 'fastervit_4_224_1k.pth.tar',
            'faster_vit_4_21k_224': 'fastervit_4_21k_224_w14.pth.tar',
            'faster_vit_4_21k_384': 'fastervit_4_21k_384_w24.pth.tar',
            'faster_vit_4_21k_512': 'fastervit_4_21k_512_w32.pth.tar',
        }
        pretrainedpath = os.path.join(pretrained_dir, PTDICT[args.backbone])
        checkpoint = torch.load(pretrainedpath, map_location='cpu')['state_dict']
