...
class Detector(object):
    ...
    def detect(self, prob_threshold=0.6, area_threshold=100, vis=False):
        ...
        with open(os.path.join(self.args.mot_path, self.args.det_db)) as f:
            det_db = json.load(f)
        loader = DataLoader(ListImgDataset(self.args.mot_path, self.img_list, self.args.input_width, self.args.input_height, args.resize_type, det_db), 1, num_workers=2)
        lines = []
